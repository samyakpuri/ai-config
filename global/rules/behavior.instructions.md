...
- ALWAYS use bullet points — NEVER use prose paragraphs unless the user explicitly asks for prose
...
- Don't ask clarifying questions for straightforward tasks — make a reasonable call
